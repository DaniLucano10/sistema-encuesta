...
const FormView: React.FC = () => {
  ...
  const allQuestionsAnswered = data?.[0]?.form_id?.questions.every(
    (question: Question) => {
                ...
                <Box width="90%" maxW="700px" mt={2}>
                  ...
                  >
                    <Text fontSize="xl" fontWeight="bold" mb={4}>
                      ¿Qué tan satisfecho estás con la atención brindada por el
                      asesor?
                    </Text>
                  </Box>
                      ...
                      >
                        <FormControl>
                          ...
                          {question.type === "Normal" ? (
                            ...
                            <CheckboxGroup
                              value={getCheckboxValue(question.id)}
                            >
                  ...
                  <Box mt={8} textAlign="center">
                    <Text fontSize="sm" color="gray.600">
                      © {new Date().getFullYear()} Derechos reservados por
                      ITSYSTEMS
                    </Text>
                  </Box>
                  <Box mt={8} />
